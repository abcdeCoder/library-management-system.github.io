...
.header {
    ...
    /* box-shadow: 0 1px 10px rgb(146 161 176 / 50%); */
    /* border-radius: 10px; */
    background-image: url(assets/images/hehe.jpg);
    overflow: hidden;
  ...
  <div class="col-sm-6">
    <div class="card jumbotron">
      <div class="card-body">
        ...
        <label for="exampleInputEmail1">Visitor's Id Card No</label>
        <input class="form-control mr-sm-2" type="search" placeholder="Enter Id Card No." name="STUDENTID">
...
<hr>
<button id="demo" class="downloadtable btn btn-primary" onclick="kingDownload()"> Download Id Card</button>
    <!-- Optional JavaScript -->
