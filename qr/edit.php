    ...
    <nav class="navbar" style="background:#fff">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li><a href="../card/index.php"><span class="glyphicon glyphicon-cog"></span> Create Library Card</a>
                </li>



                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span
                            class="glyphicon glyphicon-cog"></span> Back to LMS Control Panel <span
                            class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <!--  <li><a href="#"><span class="glyphicon glyphicon-user"></span> Student</a></li> -->
                        <li><a href="../admin/index.php"><span class="glyphicon glyphicon-plus-sign"></span>Admin</a>
                        </li>
                        <li><a href="../librarian/index.php"><span
                                    class="glyphicon glyphicon-plus-sign"></span>Librarian</a></li>
                        <li><a href="../staff/index.php"><span class="glyphicon glyphicon-plus-sign"></span> Staff</a>
                        </li>
                    </ul>
        </div>
    </nav>
                    ...
                    <table id="example1" class="table table-bordered">
                        ...
                        while ($row = $query->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td><a href="Update.php?king=<?php echo $row[
                                     'id'
                                 ]; ?>">EDIT</a>
                                <td>
                                    ...
                                    <!-- <form action="pass.php" method="post"> 
                                  	...
                                  	<input type="hidden" name="delete" value="<?php echo $row[
                                       'id'
                                   ]; ?>">
                                  	</form> -->
