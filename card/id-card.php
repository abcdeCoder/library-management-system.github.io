...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark"
        style="background-image: linear-gradient(to right, rgb(0,300,255), rgb(93,4,217));">
    ...
    <div class="row" style="margin: 0px 20px 5px 20px">
        ...
        <hr>
        <button id="demo" class="downloadtable btn btn-primary" onclick="downloadtable(e)"> Download Id Card</button>
        <!-- Optional JavaScript -->
