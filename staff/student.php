                ...
                <div class="span9">
                    ...
                    <?php
                                    if (isset($_POST['submit'])) {
                                        $s = $_POST['title'];
                                        $sql = "select * from user where (RollNo='$s' or Name like '%$s%') and Type<>'ADMIN'";
                                    } else {
                                        $sql =
                                            "select * from user where Type<>'ADMIN' and Type<>'STAFF' and Type<>'LIBRARIAN' ";
                                    }
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="studentdetails.php?id=<?php echo $rollno; ?>"
