                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" action="addbook.php" method="post">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select name="Section" tabindex="1" value="SC" data-placeholder=""
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="book" name="book" placeholder="Textbook"
                                                class="span8" required>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="Title" name="Title" placeholder="Volumes"
                                                class="span8" required>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select name="status" tabindex="1" value="SC"
