...
if (isset($_POST['export_excel'])) {
    ...
    $sql =
        'select record.BookId,id,RollNo,Textbook,Due_Date,Date_of_Issue,Date_of_Return,datediff(curdate(),Due_Date) as x from record,book where Date_of_Issue and Date_of_Return and book.Bookid = record.BookId';
...
';
    ...
    header('Content-Disposition:attachment; filename=PreviouslyBorrowed.xls');
    echo $output;
}
