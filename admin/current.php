                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="current.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        ...
                                        $sql="select record.BookId,id,RollNo,Textbook,Due_Date,Date_of_Issue,Date_of_Return,datediff(curdate(),Due_Date) as x from record,book where Date_of_Issue and Date_of_Return is NULL and book.Bookid = record.BookId";
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2022 LMS Gaurav Verma</b>All rights reserved.
            </div>
        </div>
