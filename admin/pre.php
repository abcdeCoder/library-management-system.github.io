                ...
                <div class="span9">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="title" name="title"
                                    placeholder="Enter ID No of Student/Book Name/Book Id." class="span8" required>
                    ...
                    <?php
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $sql =
                                            'select record.BookId,id,RollNo,Textbook,Date_of_Return,Date_of_Issue,datediff(curdate(),Due_Date) as x from record,book where Date_of_Issue and Date_of_Return and book.Bookid = record.BookId';
                                    }
