...
<body>
                ...
                <div class="span9">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="Textbook" name="Textbook"
                                    placeholder="Enter Book Section , Book Name, or book Status" class="span8" required>
                    ...
                    <form class="form-horizontal row-fluid" action="lab.php" method="post">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="Section" tabindex="1" value="SC" data-placeholder="" class="span3"
                    ...
                    <?php
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $sql =
                                            'SELECT * FROM book b INNER JOIN stat s ON b.stat_id = s.id INNER JOIN stock c ON b.BookId = c.id WHERE s.id = b.stat_id AND c.id = b.BookId';
                                    }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            ...
                                            <a href="modify1.php?id=<?php echo $bookid; ?>"
    ...
    <div class="footer">
        <div class="container">
            <b class="copyright">&copy; 2022 LMS <a href="https://www.linkedin.com/in/gaurav-verma-88056a224/">Gaurav Verma</a> </b>All rights
            reserved.
        </div>
    </div>
