                ...
                <div class="span9">
                    <div class="module">
                        ...
                        <div class="module-body">
                            ...
                            <br>
                            <form class="form-horizontal row-fluid" action="changestock.php?id=<?php echo $bookid; ?>"
                                method="post">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="Section" tabindex="1" value="SC" data-placeholder="" class="span8"
                                            readonly>
                                            <!--   <option value="<?php echo $status; ?>"><?php echo $status; ?> </option> -->
                                            <option value=""></option>
                                            <option value="General Reference" <?php echo $row[
                                                        'Section'
                                                    ] == 'General Reference'
                                                        ? 'selected'
                                                        : ''; ?>>General Reference</option>

                                            <option value="Reference" <?php echo $row[
                                                        'Section'
                                                    ] == 'Reference'
                                                        ? 'selected'
                                                        : ''; ?>>Reference</option>

                                            <option value="Filipiniana" <?php echo $row[
                                                        'Section'
                                                    ] == 'Filipiniana'
                                                        ? 'selected'
                                                        : ''; ?>>Filipiniana</option>

                                            <option class="Periodical" <?php echo $row[
                                                        'Section'
                                                    ] == 'Periodical'
                                                        ? 'selected'
                                                        : ''; ?>>Periodical</option>

                                            <option value="Reserved Books" <?php echo $row[
                                                        'Section'
                                                    ] == 'Reserved Books'
                                                        ? 'selected'
                                                        : ''; ?>> Reserved Books</option>

                                            <option value="Graduate Studies" <?php echo $row[
                                                        'Section'
                                                    ] == 'Graduate Studies'
                                                        ? 'selected'
                                                        : ''; ?>>Graduate Studies</option>

                                            <option value="Special Collections" <?php echo $row[
                                                        'Section'
                                                    ] == 'Special Collections'
                                                        ? 'selected'
                                                        : ''; ?>>Special Collection</option>

                                            <option value="Rare Book" <?php echo $row[
                                                        'Section'
                                                    ] == 'Rare Book'
                                                        ? 'selected'
                                                        : ''; ?>> Rare Book</option>

                                            <option value="Computer Internet Area" <?php echo $row[
                                                        'Section'
                                                    ] ==
                                                    'Computer Internet Area'
                                                        ? 'selected'
                                                        : ''; ?>>Computer Internet Area</option>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="Subject" name="Subject" placeholder="Subject"
                                            class="span8" required value="<?php echo $subject; ?>" readonly>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="book"><b>Textbook</b></label>
                                    <div class="controls">
                                        <input type="text" id="book" name="book" placeholder="Textbook" class="span8"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="Copyright" name="Copyright" placeholder="Copyright"
                                            class="span8" required value="<?php echo $year; ?>" readonly>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="Title"><b>Volume</b></label>
                                    <div class="controls">
                                        <input type="text" id="Title" name="Title" placeholder="Volumes" class="span8"
                                            required value="<?php echo $vol; ?>" readonly>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="availability" name="availability"
                                            ...
                                            value="<?php echo $avail; ?>" readonly>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="Author"><b>Author</b></label>
                                    <div class="controls">
                                        <input type="text" id="Author" name="Author" placeholder="Author" class="span8"
                                            required value="<?php echo $author; ?>" readonly>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="ISBN" name="ISBN" placeholder="ISBN" class="span8"
                                            required value="<?php echo $isbn; ?>" readonly>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <select name="status" tabindex="1" value="SC" data-placeholder="Select Status"
                                            class="span8" readonly>
                                            <!--   <option value="<?php echo $status; ?>"><?php echo $status; ?> </option> -->
                                            <option value=""></option>

                                            <option value="GOOD" <?php echo $row[
                                                        'Status'
                                                    ] == 'GOOD'
                                                        ? 'selected'
                                                        : ''; ?>>GOOD</option>

                                            <option value="DAMAGE" <?php echo $row[
                                                        'Status'
                                                    ] == 'DAMAGE'
                                                        ? 'selected'
                                                        : ''; ?>>DAMAGE</option>

                                            <option value="DILAPIDATED" <?php echo $row[
                                                        'Status'
                                                    ] == 'DILAPIDATED'
                                                        ? 'selected'
                                                        : ''; ?>>DILAPIDATED</option>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="stock" name="stock" placeholder="Book Stock"
                                            class="span8" value="">
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="stat_id" tabindex="1" value="SC" data-placeholder="Select Status"
