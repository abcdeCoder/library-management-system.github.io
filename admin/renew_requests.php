...
<?php if ($_SESSION['RollNo'] == 'admin' && 'ADMIN' && 'Admin') { ?>
                ...
                <div class="span9">
                    ...
                    <table class="table" id="tables">
                        ...
                        <tbody>
                            <?php
                            $sql =
                                'select * from record,book,renew where Date_of_Return is NULL and renew.BookId=book.BookId and renew.RollNo=record.RollNo and renew.BookId=record.BookId';
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <?php if ($renewals > 0) {
                                            echo "<a href=\"acceptrenewal.php?id1=" .
                                                $bookid .
                                                '&id2=' .
                                                $rollno .
                                                "\" class=\"btn btn-success\">Accept</a>";
                                        } ?>
                                        <a href="rejectrenewal.php?id1=<?php echo $bookid; ?>&id2=<?php echo $rollno; ?>"
