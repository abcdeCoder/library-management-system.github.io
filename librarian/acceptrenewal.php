...
if ($category == 'GEN' || $category == 'OBC') {
    $sql1 = "update LMS.record set Due_Date=date_add(Due_Date,interval 03 day),Renewals_left=0 where BookId='$bookid' and RollNo='$rollno'";
    ...
    $sql2 = "update LMS.record set Due_Date=date_add(Due_Date,interval 03 day),Renewals_left=0 where BookId='$bookid' and RollNo='$rollno'";
