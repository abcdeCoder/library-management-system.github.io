...
<?php if (
    $_SESSION['RollNo'] == 'librarian' or
    'LIBRARIAN' and 'Librarian' and 'admin' or
    'ADMIN' and 'Admin'
) { ?>
...
<body>
    ...
    $sql1 = "update user set Name='$name', EmailId='$email', MobNo='$mobno', Password='$pswd' where RollNo='$rollno'";
