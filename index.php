<?php
require 'dbconn.php'; ?>
<?php include 'private/validity1.php'; ?>
...
<body>
    ...
    if (isset($_POST['signin'])) {
        ...
        if (strcasecmp($x, $p) == 0 && !empty($u) && !empty($p)) {
            ...
            } //   if($y=='Admin') //   echo header("Location:admin/index.php"); // elseif ($y == 'librarian') { // echo header("Location:librarian/index.php"); // }if ($y =='student') { // 	echo header("Location:student/index.php"); // } //   elseif (condition) { //   	 echo	header("Location:staff/index.php"); //   }
        } else {
